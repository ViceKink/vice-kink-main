...
const ProfilePassion = ({ passion, fullWidth = false }: ProfilePassionProps) => {
  ...
  return (
    <div className={`${fullWidth ? 'w-full' : 'w-1/2'} bg-vice-dark-purple p-4 rounded-2xl flex flex-col text-white`}>
