  ...
  return (
    <div className="container py-10">
      <Tabs defaultValue="matches" className="w-full">
        <TabsList>
          <TabsTrigger value="matches" onClick={() => setActiveTab('matches')}>Matches</TabsTrigger>
          <TabsTrigger value="likes" onClick={() => setActiveTab('likes')}>Likes</TabsTrigger>
        </TabsList>
