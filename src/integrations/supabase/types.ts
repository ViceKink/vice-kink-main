  ...
  public: {
    Tables: {
      ...
      profile_interactions: {
        ...
        Relationships: [
          {
            foreignKeyName: "profile_interactions_target_profile_id_fkey"
    ...
    Functions: {
      ...
      count_unread_messages: {
        Args: { user_id: string; other_user_id: string }
        Returns: number
      }
      create_match: {
      ...
      spend_adcoins: {
        Args: { p_user_id: string; p_amount: number; p_feature: string }
        Returns: Json
      }
    }
    Enums: {
